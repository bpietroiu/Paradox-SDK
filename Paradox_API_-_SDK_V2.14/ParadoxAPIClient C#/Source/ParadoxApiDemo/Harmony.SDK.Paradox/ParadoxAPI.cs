...
using Harmony.SDK.Paradox.External;
...
namespace Harmony.SDK.Paradox
{
    ...
    public class ParadoxAPI
    {
        ...
        private static void Log(UInt32 panelID, int returnValue, string value)
        {
            ...
            {
                formRef.Invoke(logDelegate, panelID, returnValue, value);
            }
        }
        ...
        private static void NotifyTaskCompleted(UInt32 panelID, int returnValue, UInt32 ItemNo, string ItemType, string ActionType, object obj = null)
        {
            ...
            {
                formRef.Invoke(notifyTaskCompletedDelegate, panelID, returnValue, ItemNo, ItemType, ActionType, obj);
            }
        }
        ...
        private static void RefreshNotification(UInt32 panelID, int returnValue)
        {
            ...
            {
                formRef.Invoke(refreshNotificationDelegate, panelID, returnValue);
            }
        }
        ...
        private static void errorNotification(UInt32 panelID, int returnValue, string ErrorMsg)
        {
            ...
            {
                formRef.Invoke(errorNotificationDelegate, panelID, returnValue, ErrorMsg);
            }
        }
        ...
        public static int RetrievePanelInfo(UInt32 panelID, PanelInfoEx panelInfoEx)
        {
            if (panelInfoEx != null)
            {
                ...
                {
                    NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_PANEL_INFO_EX, OperationTypes.AT_READ, panelInfoEx);
                }
        ...
        public static int ReadArea(UInt32 panelID, UInt32 areaNo, PanelArea panelArea)
        {
            if (panelArea != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, areaNo, PanelObjectTypes.OT_AREA, OperationTypes.AT_READ);
        ...
        public static int ReadAllAreas(UInt32 panelID, PanelAreaList panelAreas)
        {
            if (panelAreas != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_AREAS, OperationTypes.AT_READ);
        ...
        public static int ReadZone(UInt32 panelID, UInt32 zoneNo, PanelZone panelZone)
        {
            if (panelZone != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, zoneNo, PanelObjectTypes.OT_ZONE, OperationTypes.AT_READ);
        ...
        public static int ReadAllZones(UInt32 panelID, PanelZoneList panelZones)
        {
            if (panelZones != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_ZONES, OperationTypes.AT_READ);
        ...
        public static int ReadPGM(UInt32 panelID, UInt32 pgmNo, PanelPGM panelPGM)
        {
            if (panelPGM != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, pgmNo, PanelObjectTypes.OT_PGM, OperationTypes.AT_READ);
        ...
        public static int ReadAllPGMs(UInt32 panelID, PanelPGMList panelPGMs)
        {
            if (panelPGMs != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_PGMS, OperationTypes.AT_READ);
        ...
        public static int ReadDoor(UInt32 panelID, UInt32 doorNo, PanelDoor panelDoor)
        {
            if (panelDoor != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, doorNo, PanelObjectTypes.OT_DOOR, OperationTypes.AT_READ);
        ...
        public static int WriteDoor(UInt32 panelID, UInt32 doorNo, PanelDoor panelDoor)
        {
            if (panelDoor != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, doorNo, PanelObjectTypes.OT_DOOR, OperationTypes.AT_WRITE);
        ...
        public static int ReadAllDoors(UInt32 panelID, PanelDoorList panelDoors)
        {
            if (panelDoors != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_DOORS, OperationTypes.AT_READ);
        ...
        public static int ReadUser(UInt32 panelID, UInt32 userNo, PanelUser panelUser)
        {
            if (panelUser != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, userNo, PanelObjectTypes.OT_USER, OperationTypes.AT_READ);
        ...
        public static int WriteUser(UInt32 panelID, UInt32 userNo, PanelUser panelUser)
        {
            if (panelUser != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, userNo, PanelObjectTypes.OT_USER, OperationTypes.AT_WRITE);
        ...
        public static int ReadAllUsers(UInt32 panelID, PanelUserList panelUsers)
        {
            if (panelUsers != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_USERS, OperationTypes.AT_READ);
        ...
        public static int WriteMultipleUsers(UInt32 panelID, PanelUserList panelUsers)
        {
            if (panelUsers != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_USERS, OperationTypes.AT_WRITE);
        ...
        public static int ReadSchedule(UInt32 panelID, UInt32 scheduleNo, PanelSchedule panelSchedule)
        {
            if (panelSchedule != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, scheduleNo, PanelObjectTypes.OT_SCHEDULE, OperationTypes.AT_READ);
        ...
        public static int WriteSchedule(UInt32 panelID, UInt32 scheduleNo, PanelSchedule panelSchedule)
        {
            if (panelSchedule != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, scheduleNo, PanelObjectTypes.OT_SCHEDULE, OperationTypes.AT_WRITE);
        ...
        public static int ReadAllSchedules(UInt32 panelID, PanelScheduleList panelSchedules)
        {
            if (panelSchedules != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_SCHEDULES, OperationTypes.AT_READ);
        ...
        public static int ReadAccessLevel(UInt32 panelID, UInt32 accessLevelNo, PanelAccessLevel panelAccessLevel)
        {
            if (panelAccessLevel != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, accessLevelNo, PanelObjectTypes.OT_ACCESS_LEVEL, OperationTypes.AT_READ);
        ...
        public static int WriteAccessLevel(UInt32 panelID, UInt32 accessLevelNo, PanelAccessLevel panelAccessLevel)
        {
            if (panelAccessLevel != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, accessLevelNo, PanelObjectTypes.OT_ACCESS_LEVEL, OperationTypes.AT_WRITE);
        ...
        public static int ReadAllAccessLevels(UInt32 panelID, PanelAccessLevelList panelAccessLevels)
        {
            if (panelAccessLevels != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_ACCESS_LEVELS, OperationTypes.AT_READ);
        ...
        public static int ReadHolidays(UInt32 panelID, PanelHolidayList panelHolidayList)
        {
            if (panelHolidayList != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_HOLIDAYS, OperationTypes.AT_READ);
        ...
        public static int WriteHolidays(UInt32 panelID, PanelHolidayList panelHolidayList)
        {
            if (panelHolidayList != null)
            {
                ...
                NotifyTaskCompleted(panelID, returnValue, 0, PanelObjectTypes.OT_HOLIDAYS, OperationTypes.AT_WRITE);
        ...
        public static int WriteIPReporting(UInt32 panelID, UInt32 receiverID, PanelIPReporting panelIPReporting)
        {
            if (panelIPReporting != null)
            {
                ...
                {
                    NotifyTaskCompleted(panelID, returnValue, (UInt32)panelIPReporting.ReceiverNo, PanelObjectTypes.OT_IP_RECEIVER, OperationTypes.AT_WRITE);
                }
        ...
        public static int ReadIPReporting(UInt32 panelID, UInt32 receiverID, PanelIPReporting panelIPReporting)
        {
            if (panelIPReporting != null)
            {
                ...
                {
                    NotifyTaskCompleted(panelID, returnValue, (UInt32)panelIPReporting.ReceiverNo, PanelObjectTypes.OT_IP_RECEIVER, OperationTypes.AT_READ, panelIPReporting);
                }
